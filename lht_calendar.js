...
function calCaption(calDate) {
   ...
   let monthName = ["Janurary", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
...
function calWeekdayRow() {
   ...
   //Loop through the dayName array creating table heading for each day
...
//Definition of the daysInMonth funtion that calculates the number of days in the given month=====================================================================
function daysInMonth(calDate) {
   //Array of days in each month
   let dayCount = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];

   //Extract the four digit year value for the month
   let thisYear = calDate.getFullYear();
   let thisMonth = calDate.getMonth();
...
//Definition of calDays function to write table rows and columns for each day of the month==============================================================================
function calDays(calDate) {
   ...
   for (let i = 1; i <= totalDays; i++) {
     ...
     if (weekDay === 0) htmlCode += "<tr>"; //shorthand IF
